...
#this is the maximum resolution I can get the pi to support with current webcam
width = 352 
height = 288 
...
###MCP3008 code adopted from adafruit: http://learn.adafruit.com/reading-a-analog-in-and-controlling-audio-volume-with-the-raspberry-pi
##SPI setup
...
# SPI port. These are the ports for the analog-shield in the camera frame project.
SPICLK = 4
SPIMISO = 17
SPIMOSI = 21
SPICS = 22
